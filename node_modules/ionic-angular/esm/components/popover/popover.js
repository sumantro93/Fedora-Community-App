...
PopoverCmp = __decorate([Component({
    ...
    template: '<ion-backdrop (click)="bdClick($event)" [class.hide-backdrop]="!d.showBackdrop"></ion-backdrop>' + '<div class="popover-wrapper">' + '<div class="popover-arrow"></div>' + '<div class="popover-content">' + '<div class="popover-viewport">' + '<div #viewport></div>' + '</div>' + '</div>' + '</div>'
...
var PopoverTransition = function (_Transition) {
    _inherits(PopoverTransition, _Transition);

    function PopoverTransition(opts) {
        _classCallCheck(this, PopoverTransition);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(PopoverTransition).call(this, opts));
    }
...
var PopoverPopIn = function (_PopoverTransition) {
    ...
    function PopoverPopIn(enteringView, leavingView, opts) {
        ...
        var _this4 = _possibleConstructorReturn(this, Object.getPrototypeOf(PopoverPopIn).call(this, opts));

        _this4.enteringView = enteringView;
        _this4.leavingView = leavingView;
        _this4.opts = opts;
...
var PopoverPopOut = function (_PopoverTransition2) {
    ...
    function PopoverPopOut(enteringView, leavingView, opts) {
        ...
        var _this6 = _possibleConstructorReturn(this, Object.getPrototypeOf(PopoverPopOut).call(this, opts));

        _this6.enteringView = enteringView;
        _this6.leavingView = leavingView;
        _this6.opts = opts;
...
var PopoverMdPopIn = function (_PopoverTransition3) {
    ...
    function PopoverMdPopIn(enteringView, leavingView, opts) {
        ...
        var _this7 = _possibleConstructorReturn(this, Object.getPrototypeOf(PopoverMdPopIn).call(this, opts));

        _this7.enteringView = enteringView;
        _this7.leavingView = leavingView;
        _this7.opts = opts;
        var ele = enteringView.pageRef().nativeElement;
...
var PopoverMdPopOut = function (_PopoverTransition4) {
    ...
    function PopoverMdPopOut(enteringView, leavingView, opts) {
        ...
        var _this9 = _possibleConstructorReturn(this, Object.getPrototypeOf(PopoverMdPopOut).call(this, opts));

        _this9.enteringView = enteringView;
        _this9.leavingView = leavingView;
        _this9.opts = opts;
        var ele = leavingView.pageRef().nativeElement;
        var wrapper = new Animation(ele.querySelector('.popover-wrapper'));
        wrapper.fromTo('opacity', '1', '0');
        _this9.easing('ease').duration(500).fadeIn().add(wrapper);
        return _this9;
    }
