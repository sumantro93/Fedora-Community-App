...
import { raf, cancelRaf, pointerCoord } from '../../util/dom';
/**
 * @name Picker
 * @description
 *
...
}), __metadata('design:paramtypes', [typeof (_d = typeof Config !== 'undefined' && Config) === 'function' && _d || Object, typeof (_e = typeof DomSanitizationService !== 'undefined' && DomSanitizationService) === 'function' && _e || Object])], PickerColumnCmp);
/**
 * @private
 */
...
__decorate([ViewChildren(PickerColumnCmp), __metadata('design:type', typeof (_f = typeof QueryList !== 'undefined' && QueryList) === 'function' && _f || Object)], PickerDisplayCmp.prototype, "_cols", void 0);
...
}), __metadata('design:paramtypes', [typeof (_g = typeof ViewController !== 'undefined' && ViewController) === 'function' && _g || Object, typeof (_h = typeof ElementRef !== 'undefined' && ElementRef) === 'function' && _h || Object, typeof (_j = typeof Config !== 'undefined' && Config) === 'function' && _j || Object, typeof (_k = typeof NavParams !== 'undefined' && NavParams) === 'function' && _k || Object, typeof (_l = typeof Renderer !== 'undefined' && Renderer) === 'function' && _l || Object])], PickerDisplayCmp);
/**
...
var PickerSlideIn = function (_Transition) {
    ...
    function PickerSlideIn(enteringView, leavingView, opts) {
        ...
        var _this3 = _possibleConstructorReturn(this, Object.getPrototypeOf(PickerSlideIn).call(this, opts));
...
var PickerSlideOut = function (_Transition2) {
    ...
    function PickerSlideOut(enteringView, leavingView, opts) {
        ...
        var _this4 = _possibleConstructorReturn(this, Object.getPrototypeOf(PickerSlideOut).call(this, opts));
        ...
        _this4.easing('cubic-bezier(.36,.66,.04,1)').duration(450).add(backdrop).add(wrapper);
        return _this4;
    }
