...
var ToastSlideIn = function (_Transition) {
    ...
    function ToastSlideIn(enteringView, leavingView, opts) {
        ...
        var _this3 = _possibleConstructorReturn(this, Object.getPrototypeOf(ToastSlideIn).call(this, opts));
        ...
        var DURATION = 400;
        // DOM WRITES
        _this3.easing(EASE).duration(DURATION).add(wrapper);
        return _this3;
    }
...
var ToastSlideOut = function (_Transition2) {
    ...
    function ToastSlideOut(enteringView, leavingView, opts) {
        ...
        var _this4 = _possibleConstructorReturn(this, Object.getPrototypeOf(ToastSlideOut).call(this, opts));
        ...
        var DURATION = 300;
        // DOM writes
        _this4.easing(EASE).duration(DURATION).add(wrapper);
        return _this4;
    }
...
var ToastMdSlideIn = function (_Transition3) {
    ...
    function ToastMdSlideIn(enteringView, leavingView, opts) {
        ...
        var _this5 = _possibleConstructorReturn(this, Object.getPrototypeOf(ToastMdSlideIn).call(this, opts));
        ...
        var EASE = 'cubic-bezier(.36,.66,.04,1)';
        var DURATION = 400;
        _this5.easing(EASE).duration(DURATION).add(wrapper);
        return _this5;
    }
...
var ToastMdSlideOut = function (_Transition4) {
    ...
    function ToastMdSlideOut(enteringView, leavingView, opts) {
        ...
        var _this6 = _possibleConstructorReturn(this, Object.getPrototypeOf(ToastMdSlideOut).call(this, opts));
        ...
        var EASE = 'cubic-bezier(.36,.66,.04,1)';
        var DURATION = 450;
        _this6.easing(EASE).duration(DURATION).add(wrapper);
        return _this6;
    }
...
var ToastWpPopIn = function (_Transition5) {
    ...
    function ToastWpPopIn(enteringView, leavingView, opts) {
        ...
        var _this7 = _possibleConstructorReturn(this, Object.getPrototypeOf(ToastWpPopIn).call(this, opts));
...
var ToastWpPopOut = function (_Transition6) {
    ...
    function ToastWpPopOut(enteringView, leavingView, opts) {
        ...
        var _this8 = _possibleConstructorReturn(this, Object.getPrototypeOf(ToastWpPopOut).call(this, opts));
