...
var MDTransition = function (_Transition) {
    ...
    function MDTransition(enteringView, leavingView, opts) {
        ...
        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(MDTransition).call(this, opts));
        ...
        if (leavingView && backDirection) {
            ...
            _this.add(leavingPage.fromTo(TRANSLATEY, CENTER, OFF_BOTTOM).fadeOut());
        }
        return _this;
    }
