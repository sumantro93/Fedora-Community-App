import { ElementRef, NgZone, Renderer, ComponentResolver, ViewContainerRef, Type, ChangeDetectorRef, EventEmitter } from '@angular/core';
...
export declare class Tab extends NavController {
    ...
    constructor(parentTabs: Tabs, app: App, config: Config, keyboard: Keyboard, elementRef: ElementRef, zone: NgZone, renderer: Renderer, compiler: ComponentResolver, _cd: ChangeDetectorRef);
    /**
     * @private
     */
