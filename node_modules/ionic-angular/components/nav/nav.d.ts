import { ElementRef, ViewContainerRef, ComponentResolver, NgZone, Renderer, AfterViewInit } from '@angular/core';
...
export declare class Nav extends NavController implements AfterViewInit {
    private _root;
    private _hasInit;
    constructor(viewCtrl: ViewController, parent: NavController, app: App, config: Config, keyboard: Keyboard, elementRef: ElementRef, zone: NgZone, renderer: Renderer, compiler: ComponentResolver);
    /**
     * @private
     */
